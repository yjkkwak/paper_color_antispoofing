...
testdbpath1 = os.path.join(dbprefix, "Test_Protocal_4C3_CASIA_1by1_260x260.db.sort")
testdbpath2 = os.path.join(dbprefix, "Test_Protocal_4C3_OULU_1by1_260x260.db.sort")
...
def trainmodel():
  ...
  traindataset = lmdbDatasetwmixupwlimit(args.lmdbpath, transforms)
  ...
  for epoch in range(startepoch, args.epochs):
    ...
    if averagemetermap["acc_am"].avg > 93.0:#98
      hter1 = testsiamesemodel(epoch, mynet, testdbpath1, strckptpath)
      if besthter1 > hter1:
        besthter1 = hter1
        save_ckpt(epoch, mynet, optimizer)
        copyfile(strlogpath, "{}/trainlog_1.txt".format(strckptpath))
      hter2 = testsiamesemodel(epoch, mynet, testdbpath2, strckptpath)
      if besthter2 > hter2:
        besthter2 = hter2
        save_ckpt(epoch, mynet, optimizer)
        copyfile(strlogpath, "{}/trainlog_2.txt".format(strckptpath))
