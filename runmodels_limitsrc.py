...
def runjobs():
  ...
  strpython = "python -u /home/user/work_2022/Paper_AntiSpoofing/train_regwgrlsiamese_limitsrc.py"
  ...
  strrandom_seed = 202204081
  strgpu = 1
  strDB = "Train_Protocal_4C3_CASIA_MSU_REPLAY_1by1_260x260"
  send4C4jobs(strpython, strbaseckpt, strDB, stropti, strlr, strgamma, nepoch, strbsize, strgpu, strrandom_seed)

  strrandom_seed = 202204082
  strgpu = 2
  strDB = "Train_Protocal_4C3_CASIA_MSU_REPLAY_1by1_260x260"
  send4C4jobs(strpython, strbaseckpt, strDB, stropti, strlr, strgamma, nepoch, strbsize, strgpu, strrandom_seed)

  strrandom_seed = 202204083
  strgpu = 3
  strDB = "Train_Protocal_4C3_CASIA_MSU_REPLAY_1by1_260x260"
  send4C4jobs(strpython, strbaseckpt, strDB, stropti, strlr, strgamma, nepoch, strbsize, strgpu, strrandom_seed)
...
def send4C4jobs(strpython, strbaseckpt, strDB, stropti, strlr, strgamma, nepoch, strbsize, strgpu, strrandom_seed):
  strmeta = "msegrlloss_resnet18_{}_full_siamese_limitedsrc".format(stropti)
