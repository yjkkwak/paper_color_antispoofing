...
def runjobs():
  ...
  strbaseckpt = "//home/user/data2/model_rebuttal_R2_mseonly/"
  # strbaseckpt = "/home/user/model_2022/v4C3_sample_siamese/"
  #strbaseckpt = "/home/user/model_2022/v4C3_sample_ablation/"
  #strpython = "python -u /home/user/work_2022/Paper_AntiSpoofing/train_regwgrl_rebuttal_R2_cutmixwlabelconstrain.py"
  strpython = "python -u /home/user/work_2022/Paper_AntiSpoofing/train_regwgrl_rebuttal_R2_mseonly.py"
...
def send4C4jobs(strpython, strbaseckpt, strDB, stropti, strlr, strgamma, nepoch, strbsize, strgpu, strseed):
  strmeta = "mseregloss_resnet18_{}_rebuttal_R2_mseonly".format(stropti)
